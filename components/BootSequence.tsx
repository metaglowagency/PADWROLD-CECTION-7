...
// Corrected: Initializing GoogleGenAI strictly using process.env.API_KEY as per guidelines.
const ai = new GoogleGenAI({ apiKey: process.env.API_KEY });

// Helper: Decodes raw PCM 16-bit audio data at 24kHz. 
// Do not use native AudioContext.decodeAudioData for headerless PCM streams.
...
const playSystemIntro = async () => {
    ...
    try {
        ...
        if (base64Audio) {
            ...
            const audioBuffer = await decodePcmAudio(bytes, outputAudioContext, 24000); 
